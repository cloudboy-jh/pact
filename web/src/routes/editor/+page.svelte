			...
			<div class="flex items-center gap-3">
				...
				{#if currentFile === 'pact.json'}
					<div class="relative">
						...
						{#if showLlmDropdown}
							<!-- Dropdown menu - positioned above backdrop via stacking context -->
							<!-- svelte-ignore a11y-click-events-have-key-events a11y-no-static-element-interactions -->
							<div 
								class="absolute right-0 top-full mt-1 bg-zinc-900 border border-zinc-700 rounded-lg shadow-xl overflow-hidden min-w-[180px]"
